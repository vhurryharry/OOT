...
class CustomerRepository
{
    ...
    public function findAssignedCourses(Customer $customer): array
    {
        return $this->db->findAll(
            'select * from course_instructor as cr join course as c on cr.course_id = c.id where cr.customer_id = ?',
            [$customer->getId()->toString()]
        );
    }
