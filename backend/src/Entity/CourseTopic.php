...
class CourseTopic implements JsonSerializable
{
    /**
     * @var int
     */
    ...
    public static function fromDatabase(array $row): CourseTopic
    {
        $instance = new CourseTopic();
    ...
    public static function fromJson(array $row): CourseTopic
    {
        $instance = new CourseTopic();
