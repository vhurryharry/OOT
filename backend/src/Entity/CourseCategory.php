...
class CourseCategory implements JsonSerializable
{
    /**
     * @var int
     */
    ...
    public static function fromDatabase(array $row): CourseCategory
    {
        $instance = new CourseCategory();
    ...
    public static function fromJson(array $row): CourseCategory
    {
        $instance = new CourseCategory();
