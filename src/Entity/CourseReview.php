...
class CourseReview implements JsonSerializable
{
    /**
     * @var int
     */
    ...
    public static function fromDatabase(array $row): CourseReview
    {
    ...
    public static function fromJson(array $row): CourseReview
    {
        $instance = new CourseReview();
