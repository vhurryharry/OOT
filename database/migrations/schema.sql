...
create index on course_payment using btree (id);
...
create index on faq(created_at);
create index on faq(updated_at);
create index on faq(deleted_at);
create trigger apply_update_timestamp before update on faq for each row execute procedure apply_update_timestamp();
...
create index on notification(created_at);
create index on notification(updated_at);
create index on notification(deleted_at);
create trigger apply_update_timestamp before update on notification for each row execute procedure apply_update_timestamp();
